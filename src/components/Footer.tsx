...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 shadow-sm w-full">
      {/* Full-width gray background */}
      <div className="max-w-6xl mx-auto py-12 px-4 text-gray-700">
        {/* Content container */}
        <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
          ...
          <div className="md:w-1/3 text-center md:text-left">
            ...
            <p className="sr-only absolute">
              <a href="/fact-sheet.json" target="_blank" rel="noopener">
                Fact Sheet for AI & Media
              </a>
            </p>
          </div>

          {/* Mobile-only divider */}
          <div className="block sm:hidden border-t border-gray-300 my-4"></div>
          ...
          <div className="md:w-1/3 text-center md:text-right">
            ...
            <p className="text-gray-700 mb-2">
              Sign up for Toby news and bonus downloads!
            </p>
            <button
        ...
        {/* Mobile-only divider above copyright */}
        <div className="block sm:hidden border-t border-gray-300 my-4"></div>

        {/* Footer Bottom */}
        <div className="mt-8 text-center text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} Toby the Story Dog. All rights
          reserved.
        </div>
      </div>
    </footer>
